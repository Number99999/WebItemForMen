<%-- 
    Document   : signin
    Created on : Apr 24, 2022, 3:00:10 AM
    Author     : MSII
--%>
            ...
            <div class="container">
                ...
                <div class="signin-right " id="a-sign">
                    <form action="signin" method="post">
                        ...
                        <div class="submit">
                            <button class="btn" type="submit" class="submit">Sign In</button>   <!-- dùng input k submit được -->
                            <div class="forgetpassword">
                                <p id="quenmk">Quên mật khẩu?</p> hoặc <a href="signup.html">Đăng kí</a>
                            </div>
