...
<head>
    ...
    <title>Sản Phẩm | Quản Lý Sản Phẩm</title>
...
<body onload="time()">
    <script>
        swal("Xin Chào Admin", "Chào mừng đến với Aristino", "");
    </script>
    ...
    <div class="container-fluid al">
        ...
        <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top"
            title="Thêm Sản Phẩm"><i class="fas fa-user-plus"></i></button>
        ...
        <table class="table table-bordered" id="myTable">
            ...
            <c:forEach items="${list}" var="p">
                <tr>
                    ...
                    <td>${p.price}</td>
                    <td>
                        <img src="${p.link_img}" width="100px">
                    </td>
                    <td>${p.soLuong}</td>
                    <td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
                    '<td><input type="text" class="form-control" name="name" id="name" placeholder="Mã sản phẩm"></td>' +
                    '<td><input type="text" class="form-control" name="gioitinh" id="gioitinh" placeholder="Nhập Tên sản phẩm"></td>' +
                    '<td><input type="text" class="form-control" name="namsinh" id="namsinh" value="" placeholder="Nhập Mô tả"></td>' +
                    '<td><input type="text" class="form-control" name="diachi" id="diachi" value="" placeholder="Nhập Giá"></td>' +
                    '<td><input type="file" name="txtpic" accept=".PNG,.GIF,.JPG,.JPGEG" placeholder="Chọn ảnh"></td>' +
                    '<td>' + actions + '</td>' +
                    '</tr>';
                $("table").append(row);
            ...
            $(document).on("click", ".add", function () {
                ...
                input.each(function () {
                    if (!$(this).val()) {
                        ...
                        swal("Thông Báo!", "Bạn Chưa nhập thông tin", "warning");
                    }
                });
                ...
                if (!empty) {
                    input.each(function () {
                        ...
                        swal("Thành Công", " Đã Cập Nhật Thành Công", "success");
                    });
            ...
            jQuery(function () {
                jQuery(".add").click(function () {
                    swal("Thành Công!", " Đã Sửa Thành Công", "success");
                });
            });
            // Xóa
