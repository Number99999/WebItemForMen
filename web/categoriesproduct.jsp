        ...
        <div class="container">
            <div class="hot_sp" style="padding-bottom: 10px;">
                <h2 style="text-align:center;padding-top: 10px">
                    <a style="font-size: 28px;color: black;text-decoration: none" href="">Danh sách danh mục</a>
                </h2>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                        <div class="product-block">
                            <div class="product-img fade-box">
                                <a href="detailproduct.html" title="${o.name_prod}" class="img-resize">
                                    <img src="${o.link_img}"
                            ...
                            <div class="product-detail clearfix">
                                ...
                                <tr>
                                    ...
                                    <td><a href="" class="linktocheckout button ">Mua Ngay</a></td>
                                </tr>
                            </div>
                        </div>
                    </div>
